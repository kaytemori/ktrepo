...
"""
 ...
 #Automate despotic GMC property finding to calculate the 13CO(1-0), 13CO(2-1) line
...
a1, = plt.plot(T,co10, 'ro', label='13CO(1-0)')
a2, = plt.plot(T,co21, 'b+', label='13CO(2-1)')
plt.title('Brightness of the 13CO(1-0) and 13CO(2-1) \n line emissions as a function of temperature', fontsize=14)
plt.xlabel('Tempurature (K)')
plt.ylabel('intTB (K km/s)')
plt.legend(handles = [a1,a2],loc = 'lower right')
plt.savefig('13CO(1-0) and 13CO(2-1) line brightnesses.pdf')
plt.show()